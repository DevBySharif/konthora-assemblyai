...
export const metadata: Metadata = constructMetadata({
  title: "Text-to-Speech for Podcasts | Konthora",
  description:
    "Learn how to create podcast voiceovers using text-to-speech. Discover how to choose a voice, format your script, and generate MP3 or WAV narration.",
  path: '/text-to-speech-for-podcasts',
});

/* ─────────────────────────────────────────────
   Page component
───────────────────────────────────────────── */
export default function TTSForPodcastsPage() {
  const pageUrl = `${siteConfig.url}/text-to-speech-for-podcasts`;
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Podcasts', item: pageUrl },
    ],
  };
  ...
  const howToSchema = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'How to Create Podcast Voiceovers with Konthora',
    description: 'A 5-step workflow to generate voiceover narration for your podcast.',
    step: [
      {
        '@type': 'HowToStep',
        position: 1,
        name: 'Enter your podcast script',
      ...
      },
      {
        ...
        text: 'Set the speaking speed to match the pacing of your podcast format.',
      },
      {
        '@type': 'HowToStep',
        position: 4,
  ...
  return (
    <>
      ...
      {/* ── HERO / INTRO ── */}
      <section
        aria-labelledby="tts-podcast-h1"
      ...
      >
        ...
        <Container className="relative z-10 max-w-4xl">
          ...
          >
            Text-to-Speech for <span className="text-gradient">Podcasts</span>
          </h1>

          <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
            Creating voiceovers for podcasts can help you produce consistent audio without needing expensive recording equipment. Learn how to prepare a script, choose an appropriate voice, and generate audio narration directly in your browser.
          </p>
        </Container>
      </section>

      {/* ── ARTICLE BODY ── */}
      <article aria-label="Text to speech for podcasts guide" className="border-b border-border/40">
        <Container className="max-w-4xl py-14 md:py-20">
          <div className="space-y-16">

            {/* ── H2: Why Use Text-to-Speech for Podcasts? ── */}
            <section aria-labelledby="why-use-tts">
              <h2
                id="why-use-tts"
                className="text-2xl sm:text-3xl font-bold text-foreground mb-5"
              >
                Why Use Text-to-Speech for Podcasts?
              </h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Podcast creators use <Link href="/text-to-speech" className="text-primary hover:underline">text-to-speech</Link> for many applications, including narrative storytelling, automated news updates, show introductions, and creating audio versions of written articles. 
                </p>
                <p>
            ...
            <section aria-labelledby="choosing-the-right-voice">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Konthora provides 41 AI <Link href="/voices" className="text-primary hover:underline">voices</Link> across six languages. Selecting a voice that matches the tone of your podcast is important for the listener experience.
                </p>
                <p>
                  If your podcast is aimed at an audience in the United States, you might prefer the <Link href="/voices/american-english-voices" className="text-primary hover:underline">American English</Link> voices. For content geared toward a UK audience, the <Link href="/voices/british-english-voices" className="text-primary hover:underline">British English</Link> voices can provide a different cadence and presentation style.
                </p>
              </div>
            </section>
            ...
            <section aria-labelledby="preparing-a-script">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  To get the best result for a podcast episode, use proper periods and commas to create natural breathing pauses. Since the tool has a 2,000-character limit per generation, you may need to divide longer podcast scripts into separate paragraphs and generate the audio in sections.
                </p>
              </div>
            </section>
            ...
            <section aria-labelledby="mp3-or-wav">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  For podcast editing, <Link href="/formats/mp3-vs-wav" className="text-primary hover:underline">MP3 vs WAV</Link> is a common consideration. WAV is an uncompressed format, meaning it preserves the highest audio quality, which is ideal if you plan to edit the audio further in your podcast software. MP3 is a compressed format that uses less file space and is often used for final podcast distribution.
                </p>
              </div>
            </section>
            ...
            {/* ── H2: Creating Podcast Voiceovers with Konthora ── */}
            <section aria-labelledby="creating-voiceovers">
              <h2
                id="creating-voiceovers"
                className="text-2xl sm:text-3xl font-bold text-foreground mb-5"
              >
                Creating Podcast Voiceovers with Konthora
              </h2>
              ...
              <div className="space-y-4">
                {[
                  {
                    n: 1,
                    title: 'Enter your podcast script',
                  ...
                  },
                  {
                    ...
                    body: 'Set the speaking speed to match the pacing of your podcast format.',
                  },
                  {
                    n: 4,
      ...
      {/* ── FAQ SECTION ── */}
      <Section className="bg-secondary/10" id="podcast-tts-faq">
        <Container className="max-w-4xl">
          <div className="text-center mb-12">
            <h2
              id="podcast-tts-faq-heading"
